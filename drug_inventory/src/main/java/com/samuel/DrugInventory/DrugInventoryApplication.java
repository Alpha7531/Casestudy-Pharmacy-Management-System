package com.samuel.DrugInventory;
...
public class DrugInventoryApplication {
	...
	public Docket swaggerConfig()
	{
		return new Docket(DocumentationType.SWAGGER_2)//step (1)it is just creating new Docket instance of ducument type that is configured to use swagger2
	               .select() 
	               .apis(RequestHandlerSelectors.basePackage("com.samuel.DrugInventory"))//(4) giving thebase pakage //both 3 and 4 will eliminate the 1st problem
	               .build()
	               .apiInfo(apiDetails());	
	}
